...
# Launches 30 seed×classifier instances on node11 with 5-way GNU parallel
...
#
# Usage:
#   bash run_node11.sh           # full run (10 seeds × 3 clf)
#   bash run_node11.sh --smoke   # smoke check (1 seed × 1 clf, 3 months)
