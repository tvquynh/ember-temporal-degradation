...
# Default paths (the compute server). Override via constructor for local dev / testing.
DEFAULT_PATHS = {
  "ember2017_train": "<server-data-path>ember2017_2/ember2017_2_train.parquet",
  "ember2017_test":  "<server-data-path>ember2017_2/ember2017_2_test.parquet",
  "ember2018_train": "<server-data-path>ember2018/ember2018_train.parquet",
  "ember2018_test":  "<server-data-path>ember2018/ember2018_test.parquet",
  "bodmas":  "<server-data-path>bodmas/bodmas.parquet",
}
